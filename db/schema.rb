...
ActiveRecord::Schema[8.0].define(version: 2024_10_09_162719) do
  create_table "o_auth_access_tokens", force: :cascade do |t|
    ...
    t.index ["oauth_client_id"], name: "index_o_auth_access_tokens_on_oauth_client_id"
  ...
  create_table "o_auth_refresh_tokens", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["oauth_client_id"], name: "index_o_auth_refresh_tokens_on_oauth_client_id"
  ...
  add_foreign_key "o_auth_access_tokens", "oauth_clients"
  add_foreign_key "o_auth_access_tokens", "users"
  add_foreign_key "o_auth_refresh_tokens", "oauth_clients"
